...
public class BaseRvViewHolder<T> extends RecyclerView.ViewHolder {
    ...
    public static BaseRvViewHolder createViewHolder(Context context, View itemView) {
    ...
    public BaseRvViewHolder setTextColorRes(int viewId, int textColorRes) {
        TextView view = getView(viewId);
     ...
     * 关于事件的
     */
    public BaseRvViewHolder setOnClickListener(int viewId,
    ...
    public BaseRvViewHolder setOnTouchListener(int viewId,
    ...
    public BaseRvViewHolder setOnLongClickListener(int viewId,
